...
export const canvasSlice = createSlice({
  ...
  reducers: {
     eventsObject: (state: any, action: any) => {
       state.eventsArr = action.payload;
     },
     gateObject: (state: any, action: any) => {
      state.gateArr = action.payload;
    }
  },
});

export const { eventsObject, gateObject } = canvasSlice.actions;

export const selectCanvasEvents = (state: any) => state.canvas.eventsArr;
export const selectCanvasGate = (state: any) => state.canvas.gateArr;
